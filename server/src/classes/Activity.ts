...
export default class Activity {
     ...
     */
    @Column({ type: 'timestamptz', nullable: true, comment: "The timestamp on which the activity starts"})
    from: Date | null

    /**
     * The timestamp on which the activity ends
     */
    @Column({ type: 'timestamptz', nullable: true, comment: "The timestamp on which the activity ends" })
    to: Date | null
     ...
     */
    @Column({type: "int", comment: "Break time during this task in minutes", default: 0})
    breakMins: number
