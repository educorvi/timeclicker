<template>
  <div id="settings">
    ...
    <b-input-group :prepend="t('language')">
      <b-form-select :options="Object.keys(messages)" v-model="lang"></b-form-select>
    </b-input-group>
    <b-form-valid-feedback :state="langChanged">{{t('reload_to_activate')}}</b-form-valid-feedback>
  </div>
</template>
